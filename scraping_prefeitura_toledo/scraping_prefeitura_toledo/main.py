...
def executar_bot_prefeitura(limit=None, headless=False, responsavel=None, numero=None):
    protocolos = buscar_protocolos_prefeitura(
        limit=limit,
            ...
            resumo["items"].append(
                {
                    ...
                    "salvo": False,
                    "erro": f"{type(erro_banco).__name__}: {erro_banco}",
                }
            )
            continue
        ...
        resumo["items"].append(
            {
                ...
                "salvo": salvamento.get("salvo"),
                "mudou_status": salvamento.get("mudou_status"),
            }
        )
...
def parse_args():
    ...
    parser.add_argument(
        "--responsavel",
        default=None,
        help="Filtra protocolos pelo responsavel. Ex.: Lavinia.",
    )
    parser.add_argument(
        "--numero",
        default=None,
        help="Filtra protocolos pelo numero/protocolo.",
    )
